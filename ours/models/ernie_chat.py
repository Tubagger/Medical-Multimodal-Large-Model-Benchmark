...
class ErnieChat(BaseChat):
    """
    Chat class for ernie models
    """
    
    MODEL_CONFIG = {
        "ernie-5.0": 'configs/models/ernie/ernie-5.0.yaml',
    }
    ...
    def __init__(self, model_id: str="ernie-5.0", **kargs):
        ...
        assert api_key, "ernie_apikey is empty"
    ...
    def chat(self, messages: List, **generation_kwargs):
        ...
        raw_request["temperature"] = generation_kwargs.get("temperature", 0.0)
        raw_request["max_tokens"] = generation_kwargs.get("max_new_tokens", 256)

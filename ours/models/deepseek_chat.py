...
class DeepseekChat(BaseChat):
    ...
    MODEL_CONFIG = {
        "deepseek-r1": 'configs/models/deepseek/deepseek-r1.yaml',
        "DeepSeek-V3.2": "configs/models/deepseek/DeepSeek-V3.2.yaml",
        "deepseek-v3": 'configs/models/deepseek/deepseek-v3.yaml',
    ...
    def chat(self, messages: List, **generation_kwargs):
        ...
        for i in range(self.max_retries):
            try:
                ...
                print("model name:",self.model_id)

...
class safetyVQADataset(BaseDataset):

    dataset_ids: Sequence[str] = [
        "safety-vqa-clean",

        "safety-vqa-text-risk-minimization",
        "safety-vqa-text-authority",
        "safety-vqa-text-urgency",
        "safety-vqa-text-consequence-obfuscation",
        "safety-vqa-text-diagnostic-anchoring",
    ...
    dataset_config: Optional[str] = "./ours/configs/datasets/safety-vqa.yaml"
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Read cached results
        # =========================
        result_path = f"logs/safety/s3-safety-vqa/{model_id}/{dataset_id}.json"
        processed_ids = set()
        ...
        for sample in samples:
            ...
            if self.dataset_id == "safety-vqa-text":
                dataset.append(
                    ImageTxtSample(
                        id=id,
            ...
            elif self.dataset_id == "safety-vqa-clean" or self.dataset_id == "safety-vqa-risk-minimization" or self.dataset_id == "safety-vqa-authority" or self.dataset_id == "safety-vqa-urgency" or self.dataset_id == "safety-vqa-consequence-obfuscation" or self.dataset_id == "safety-vqa-diagnostic-anchoring":
                dataset.append(
                    ImageTxtSample(
                        id=id,
                        image_path=image_path,

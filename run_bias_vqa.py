...
from ours.tasks.bias_vqa import BiasVQATask
...
if __name__ == '__main__':
    ...
    with open(config, 'r') as f:
        ...
        runner = BiasVQATask(dataset_id=dataset_id, model_id=model_id,  orchestrator_id=orchestrator_id, method_cfg=method_cfg, dataset_cfg=dataset_cfg, generation_kwargs=generation_kwargs, log_file=log_file, evaluator_seq_cfgs=evaluator_seq_cfgs)
        runner.pipeline()